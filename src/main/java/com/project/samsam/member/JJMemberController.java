...
public class JJMemberController {
	@Autowired
	private JJMemberServiceImpl memberService;
	@Autowired
	...
	public String kko_Join(JJMemberVO mvo, Model model, RedirectAttributes redi_attr) {
		System.out.println("이메일: " + mvo.getEmail() + "닉네임 : " + mvo.getNick());
		
		JJMemberVO vo = memberService.selectMember(mvo.getEmail());
	...
	//네이버 콜백
		...
		public String nid_callback(JJMemberVO mvo, Model model, RedirectAttributes redi_attr) {
	...
	public String nid_Join(JJMemberVO mvo, Model model, RedirectAttributes redi_attr) {
	...
	public String kko_joinProcess(JJMemberVO mvo) {
	...
	public String userCheck(@RequestParam("email") String email, JJMemberVO vo, HttpSession session) throws Exception {
		...
		//카카오
		JJMemberVO res = memberService.selectMember(vo.getEmail());
...
///////////////////////////////////
	...
	public String signUp(@ModelAttribute JJMemberVO memberVO) {
