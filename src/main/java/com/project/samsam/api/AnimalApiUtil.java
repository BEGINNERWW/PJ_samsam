...
public class AnimalApiUtil implements AnimalApi {
	...
	@Override
	public AnimalApiVO getAnimalInfo(String bgnde, String endde, String upkind, String state, Integer pageNo,
			Integer numOfRows, String neuter_yn) throws Exception {
	...
	// 보호 동물 정보 가져오기
	@Override
	public AnimalApiVO getAnimalInfo(String bgnde, String endde, String upr_cd, String org_cd, String upkind,
			String kind, String state, Integer pageNo, Integer numOfRows, String neuter_yn) throws Exception {
...
//			resultList.add(shelter);
			...
			ShelterInfo shelter = shelterApiUtil.getShelterDetail(shelterList.get(i).getCareRegNo());
			if (shelter == null) {
				shelterList.get(i).setCareAddr("-");
				shelterList.get(i).setCareTel("-");
				shelterList.get(i).setDivisionNm("-");
				resultList.add(shelterList.get(i));
			} else {
				resultList.add(shelter);
			}
	...
	// 요청이름에 맞는 응답 html 반환
	public StringBuilder getReponse(String requestName, int requestNo, ArrayList<String> paramNm,
			ArrayList<String> paramVal) throws Exception {
