...
<body>
   ...
   <tr><td><div id="image_container"></div></td></tr>     
     -->
      ...
      <div style="margin-bottom:10px;">책임 분양 이용약관&nbsp;&nbsp;<input type="checkbox" id="home_agree" value="Y"></div>
      <div style="margin-bottom:20px;">
      <textarea cols="156" rows="10" readonly
...
(시행일) 이 약관은 2015년 01월부터 시행합니다.
      ...
      <div><input class="btn_g full_type1" type="submit" id="home_submit" value="글 작성" style="float: right;" disabled="disabled"><input class="btn_g full_type1" type="button" value="뒤로" onclick="javascript:history.go(-1)" style="float:right; margin-right:10px;"></div></div>
