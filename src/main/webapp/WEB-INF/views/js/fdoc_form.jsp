...
$(document).ready(function() {
   ...
   $("input:radio[name=doc_big]").click(function(){
		  ...
		  if($("input[name='doc_big']:checked").val() =="강아지"){
			  ...
			  var output = '';
			  output += '<div class="option1"><input class="form-control" style="width:300px;" type="text" name="doc_kindof" id="etc_kind" placeholder="직접 입력해주세요"></div>'
				$('#kind3').append(output);
		  }
	  });
   //이용약관 동의 체크
...
<div class="main-content">
   ...
   <form method="post" action="fdoc_write.bo" enctype="multipart/form-data" onsubmit="return submit_check();">
    ...
    <div>
	<div class="option1">분양비&nbsp;&nbsp;&nbsp;&nbsp;<input class="form-control" style="width:200px; display:inline-block;" type="text" id="doc_price" name="doc_price" placeholder="분양비를 입력해주세요"></div> 
