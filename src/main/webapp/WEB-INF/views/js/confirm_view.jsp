...
<%
	ConfirmVO vo = (ConfirmVO)request.getAttribute("vo");
	int nowpage=((Integer)request.getAttribute("page")).intValue();
	String id = (String) session.getAttribute("nick");
	String email = (String) session.getAttribute("email");
	String table = "free_auth_reply";
	String doc_table = "free_auth";
...
function warning_submit(){
    ...
    function commentList(){
    	...
    	var doc_no =<%=vo.getDoc_no()%>
    	var id = '<%=id%>'
    	var writer = '<%=vo.getFadoc_r_email()%>'
			...
			<div class="content-section">
				...
				<div class="contents">
					<div class="article-head">
						<p style="font-szie:16px;font-weight:bold;">커뮤니티 &nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;책임분양 인증</p>
						<h2 class="headsubject"><%=vo.getFadoc_subject()%></h2>
						<p class="name"><%=vo.getFadoc_nick()%></p>
						...
						<div class="option-info">
							...
							<%
								if (email != null) {
									...
									if (!email.equals(vo.getFadoc_r_email())) {
							%>
							<span><a href="#"
								onclick="warning_ori(<%=vo.getDoc_no()%>,'<%=vo.getFadoc_nick()%>','<%=vo.getFadoc_subject()%>');">신고하기</a></span>
							<%
								}
								}
							%>
