	...
	<div class="wrap">
		<div class="aside">
			<ul class="list-group list-group-flush">
				<li class="list-group-item"><a href="/SJ/pet_list">보호소</a></li>
				<li class="list-group-item"><a href="/SJ/payang/list">파양</a></li>
				<li class="list-group-item"><a href="/SJ/missing/list">실종</a></li>
			</ul>
		</div>
		...
		<div class="section">
			...
			<div class="tab">
				<div class="tab-left">
					<a href="/SJ/pet_list" alt="보호 동물">보호 동물</a>
				</div>
				<div class="tab-right">
					<a href="/SJ/shelter_list" alt="보호소 찾기">보호소 찾기</a>
				</div>
			</div>
