...
<%
	...
	String table = "payang_reply";
	String doc_table = "payang_doc";
%>
...
<script>
	...
	function commentModify(doc_cno, textVal, item) {
		...
		$.ajax({
		    url:'${pageContext.request.contextPath}/SJ/payang/comment_modify', //request 보낼 서버의 경로
		    type : 'get',
    		data :  {	
    					'doc_no' : doc_no,
    					'doc_cno' : doc_cno,
	...
	function commentRemove(doc_cno) {
		...
		$.ajax({
		    url:'${pageContext.request.contextPath}/SJ/payang/comment_remove', //request 보낼 서버의 경로
		    type : 'get',
    		data :  {	
    					'doc_no' : doc_no,
    					'doc_cno' : doc_cno
	...
	function rereplyInsert(doc_cno){
		...
		$.ajax({
			url : '${pageContext.request.contextPath}/SJ/payang/recomment_insert',
			type : 'POST',
			data : {
				'doc_no' : doc_no,
    ...
    function reflyInsert(cno){
    	...
    	$.ajax({
    		url: '${pageContext.request.contextPath}/SJ/payang/comment_refly.bo',
    		//type: 'post',
    		dataType : 'json',
