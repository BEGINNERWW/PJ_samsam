						...
						<div class="option-info">
							...
							<div class="option-wrap">
								...
								<c:if test="${nick == missing.doc_nick}">
									<span><a href="${pageContext.request.contextPath}/SJ/missing/modify?doc_no=${missing.doc_no}">수정</a>&nbsp;&nbsp;&nbsp;</span>
									<span><a href="${pageContext.request.contextPath}/SJ/missing/remove?doc_no=${missing.doc_no}">삭제</a></span>
								</c:if>
							</div>
						</div>
					</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#btnModify').on('click',function() {
			...
			location.href = "${pageContext.request.contextPath}/SJ/missing/modify?doc_no=" + doc_no;
		});
		 
		// 삭제 버튼 클릭 이벤트
		$('#btnRemove').on('click',function() {
			form.attr("action", "${pageContext.request.contextPath}/SJ/missing/remove");
		...
		$('#btnList').on('click',function() {
			location.href = "${pageContext.request.contextPath}/SJ/missing/list";
		}); 
	...
	function commentInsert() {
		...
		$.ajax({
		    url:'${pageContext.request.contextPath}/SJ/missing/comment_insert', //request 보낼 서버의 경로
		    type : 'POST',
    		data :  {	'doc_no' : doc_no,
	...
	function commentList() {
		...
		$.ajax({
		    url:'${pageContext.request.contextPath}/SJ/missing/comment_list', //request 보낼 서버의 경로
		    type : 'GET',
    		data :  {	
    					'doc_no' : doc_no
    				},
