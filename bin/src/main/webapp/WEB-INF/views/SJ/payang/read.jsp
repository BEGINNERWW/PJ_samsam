			...
			<div class="content-section">
				...
				<div class="contents">
					<div class="article-head">
						...
						<div class="option-info">
							<span class="big option">
								<c:set var="bigname" value="${payang.doc_big_name}" />
								<c:if test="${bigname == '개'}">
						...
						<div class="option-info">
							<span class="date option"><i class="far fa-clock"></i>&nbsp;${payang.doc_date}</span>
							<span class="pv option"><i class="far fa-eye"></i>&nbsp;${payang.doc_readcount}</span>
							<span class="cmt"><i class="far fa-comment"></i>&nbsp;${payang.doc_comment}</span>
							<div class="option-wrap">
								<span><a href="#"
								onclick="warning_ori('${payang.doc_no}','${payang.doc_nick}','${payang.doc_subject}');">신고하기</a></span>
					...
					<div style="text-align: right; padding: 30px;">
						<a href="${pageContext.request.contextPath}/SJ/payang/list">목록</a>
					</div>
